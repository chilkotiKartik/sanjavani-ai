...
**3. Hindi, Hinglish and Bengali.** Start a new conversation and type:
...
Then start again in Bengali:

> "আমার দু দিন ধরে খুব জ্বর আর গা ব্যথা"

The follow-up question, the urgency, the care advice, the warning signs and the
disclaimer all come back in Bengali — those are four different layers of the system, and
an untranslated one would show up here as English. Answer "না" and the advice arrives.

Settings → Language shows the other half of the story: Bengali says, in Bengali, that
the longer explanatory screens are still English. So do Hindi and Hinglish, which were
always partly English and never said so.
