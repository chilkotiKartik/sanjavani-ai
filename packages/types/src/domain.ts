...
/** Who the conversation is about. See `SUBJECTS` for why the relationship is kept. */
...
export const triageResultSchema = z.object({
  ...
  /**
   * Who this is about. Carried onto the care card because "who is the patient" is the
   * first thing anyone reading it needs, and getting it from context beats asking
   * someone to re-state it at a hospital desk.
   *
   * Defaulted for the same reason as `ruledOut`: conversations stored before this
   * field existed must still parse.
   */
  subject: subjectSchema.default('unknown'),
