...
export const RED_FLAG_SCREENS: Record<RedFlagScreenId, RedFlagScreen> = {
  ...
  ai_emergency_confirm: {
    ...
    question: {
      ...
      bn: 'আমি সাবধান থাকতে চাই। এটা কি এই মুহূর্তে হচ্ছে এবং গুরুতর মনে হচ্ছে — যেমন বুকে ব্যথা, শ্বাস নিতে কষ্ট, প্রচুর রক্তক্ষরণ বা অজ্ঞান হয়ে যাওয়া?',
    },
    positiveAnswer: 'yes',
  ...
  fever_danger: {
    ...
    question: {
      ...
      bn: 'কোনও ফুসকুড়ি, ঘাড় শক্ত হয়ে যাওয়া, অসংলগ্ন ভাব, বা শ্বাস নিতে কষ্ট আছে?',
    },
    positiveAnswer: 'yes',
  ...
  headache_sudden: {
    ...
    question: {
      ...
      bn: 'এটা কি হঠাৎ শুরু হয়েছে এবং এ যাবৎকালের সবচেয়ে তীব্র মনে হচ্ছে, নাকি সঙ্গে দুর্বলতা, অসাড়তা বা ঝাপসা দেখা আছে?',
    },
    positiveAnswer: 'yes',
  ...
  abdominal_severe: {
    ...
    question: {
      ...
      bn: 'ব্যথা কি তীব্র ও একটানা, নাকি বমি বা পায়খানায় রক্ত আছে?',
    },
    positiveAnswer: 'yes',
    onPositive: { urgency: 'urgent' },
  },
  gi_hydration: {
    ...
    question: {
      ...
      bn: 'জল কি পেটে থাকছে এবং প্রস্রাব স্বাভাবিক হচ্ছে?',
    },
    positiveAnswer: 'no',
    onPositive: { urgency: 'urgent' },
  },
  respiratory: {
    ...
    question: {
      ...
      bn: 'শ্বাসকষ্ট হচ্ছে, নাকি কাশির সঙ্গে রক্ত আসছে?',
    },
    positiveAnswer: 'yes',
    onPositive: { urgency: 'urgent' },
  },
  injury_severity: {
    ...
    question: {
      ...
      bn: 'প্রচুর রক্তক্ষরণ, হাড় বেঁকে গেছে বলে মনে হওয়া, বা মাথায় আঘাত — এর কিছু আছে?',
    },
    positiveAnswer: 'yes',
    onPositive: { urgency: 'urgent' },
  },
  dizziness_faint: {
    ...
    question: {
      ...
      bn: 'আপনি কি অজ্ঞান হয়ে গিয়েছিলেন, নাকি বুকে ব্যথা বা শরীরের একদিকে দুর্বলতা আছে?',
    },
    positiveAnswer: 'yes',
    onPositive: { urgency: 'urgent' },
  },
  allergy_airway: {
    ...
    question: {
      ...
      bn: 'মুখ, ঠোঁট বা জিভ ফুলে গেছে, বা শ্বাস নিতে কষ্ট হচ্ছে?',
    },
    positiveAnswer: 'yes',
  ...
  mood_safety: {
    ...
    question: {
      ...
      bn: 'আমি নিশ্চিত হতে চাই যে আপনি নিরাপদ আছেন। নিজের ক্ষতি করার কোনও চিন্তা কি আসছে?',
    },
    positiveAnswer: 'yes',
  ...
  urinary_spread: {
    ...
    question: {
      ...
      bn: 'সঙ্গে জ্বর, কোমরে ব্যথা বা বমিও কি আছে?',
    },
    positiveAnswer: 'yes',
    onPositive: { urgency: 'urgent' },
  },
  eye_vision: {
    ...
    question: {
      ...
      bn: 'দৃষ্টি কি হঠাৎ বদলে গেছে, নাকি চোখে আঘাত লেগেছে?',
    },
    positiveAnswer: 'yes',
    onPositive: { urgency: 'urgent' },
  },
  pregnancy_danger: {
    ...
    question: {
      ...
      bn: 'রক্তপাত, তীব্র ব্যথা, প্রচণ্ড মাথা ব্যথা — এর কিছু আছে, নাকি বাচ্চার নড়াচড়া বন্ধ হয়ে গেছে?',
    },
    positiveAnswer: 'yes',
  ...
  palpitations_danger: {
    ...
    question: {
      ...
      bn: 'এর সঙ্গে বুকে ব্যথা, শ্বাসকষ্ট, বা অজ্ঞান হয়ে যেতে পারেন এমন মনে হচ্ছে?',
    },
    positiveAnswer: 'yes',
  ...
  burn_size: {
    ...
    question: {
      ...
      bn: 'পোড়া জায়গাটা কি আপনার হাতের চেটোর চেয়ে বড়, অনেক ফোসকা পড়েছে, নাকি মুখে, হাতে বা গোপনাঙ্গে?',
    },
    positiveAnswer: 'yes',
    onPositive: { urgency: 'urgent' },
  },
