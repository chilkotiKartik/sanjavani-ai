...
const PAST_MARKERS = compileAll(
  [
    ...
    'গত বছর', 'গত মাসে', 'বছর আগে', 'মাস আগে', 'অনেক আগে', 'আগে হয়েছিল', 'সেরে গিয়েছিল', 'ছোটবেলায়',
    'goto bochor', 'bochor age', 'age hoyechilo',
  ],
  1,
);
...
const HYPOTHETICAL_MARKERS = compileAll(
  [
    ...
    'যদি কারো', 'যদি কেউ', 'কী করব যদি', 'ধরুন', 'এমনি জিজ্ঞাসা',
    'jodi karo', 'ki korbo jodi',
  ],
  1,
);
...
const PRESENT_MARKERS = compileAll(
  [
    ...
    'এখনই', 'এখনও', 'এই মুহূর্তে', 'আজ', 'আজকে', 'আজ থেকে', 'সকাল থেকে', 'কাল থেকে', 'রাত থেকে', 'হচ্ছে', 'চলছে',
    'ekhoni', 'ajke theke', 'hocche',
  ],
  1,
);
