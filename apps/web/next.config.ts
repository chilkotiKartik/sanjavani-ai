...
const config: NextConfig = {
  ...
  /*
   * Workspace packages ship TypeScript source rather than compiled JavaScript, so
   * every one the app reaches has to be listed here — including `ai` and `maps`,
   * which are only reached through a dynamic import and a subpath. Leaving those out
   * happened to work and would have kept working right up until it did not.
   */
  transpilePackages: [
    '@sanjeevani/ui',
    '@sanjeevani/types',
    '@sanjeevani/config',
    '@sanjeevani/medical-safety',
    '@sanjeevani/ai',
    '@sanjeevani/maps',
  ],
  async rewrites() {
