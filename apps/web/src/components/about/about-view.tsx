...
// The ranking module directly, not the package barrel: the barrel also exports the
// Google Places and Routes providers, and none of that belongs in a browser bundle.
import { RANKING_WEIGHTS } from '@sanjeevani/maps/ranking';
