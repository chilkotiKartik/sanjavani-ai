...
import { Accessibility, BookMarked, CalendarClock, ChevronRight, Gauge, Info, Languages, MessageSquareHeart, ShieldCheck, Sparkles, UserRound } from 'lucide-react';
  ...
  const groups: { title: MessageKey; rows: Row[] }[] = [
    {
      ...
      rows: [
        ...
        { href: '/check-ins', icon: CalendarClock, label: 'ciTitleLong' },
    ...
    },
    {
      title: 'about',
      rows: [
        { href: '/overview', icon: Sparkles, label: 'overviewTitle' },
        { href: '/about', icon: Info, label: 'aboutTitle' },
        { href: '/guide', icon: Sparkles, label: 'guideTitle' },
        // Deliberately here rather than on the home screen: it is for reviewers, not
        // for anyone who came to this app because they feel unwell.
        { href: '/dashboard', icon: Gauge, label: 'dashTitle' },
