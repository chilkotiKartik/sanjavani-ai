...
/*
 * The document language drives screen-reader pronunciation and the font the browser
 * picks for the script, so it has to follow the language actually on screen. Hinglish
 * is Hindi written in Latin script, which is exactly what hi-Latn means.
 */
const HTML_LANG: Record<Language, string> = { hi: 'hi', hinglish: 'hi-Latn', bn: 'bn', en: 'en-IN' };
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    document.documentElement.lang = HTML_LANG[uiLanguage];
  }, [uiLanguage]);
